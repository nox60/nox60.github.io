...
configtxgen -profile OnlyOrdererGenesis -channelID myme-channel -outputBlock genesis.block
...
/root/test/crypto-config-test/ordererOrganizations/mydomain.net/orderers/orderer.mydomain.net/msp
